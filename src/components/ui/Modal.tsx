    ...
    <Transition.Root show={show} as={Fragment}>
      ...
      >
        <div className='flex min-h-screen items-center justify-center pt-32 text-center sm:block sm:p-0'>
          ...
          >
            <div className='relative mx-4 inline-block w-full overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 sm:align-middle'>
              <div
                className={clsx({
              ...
              >
                ...
                <div
                  className={clsx('mt-3 text-center', {
                    ...
                    'sm:ml-4 sm:mt-0 sm:text-left': variant === 'alert',
                  })}
                >
                  <h3
