...
export function Notification({
  ...
  return (
    <div
      ...
      className={clsx(
        className,
        'pointer-events-none fixed inset-0 z-[999] flex items-end justify-center px-4 py-6 sm:items-start sm:justify-end sm:p-6'
      )}
    >
          ...
          <div className='p-4'>
            ...
            >
              ...
              >
                ...
                <p className='mt-1 font-medium leading-5 text-gray-500'>
                  {content}
                </p>
              </div>
